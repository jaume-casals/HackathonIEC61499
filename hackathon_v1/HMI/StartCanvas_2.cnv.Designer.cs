...
this.canvasTopologyNavigation = new NxtControl.GuiFramework.CanvasTopologyRose();
      ...
      this.canvasTopologySeparator2.Bounds = new NxtControl.Drawing.RectF(((float)(1760)), ((float)(0)), ((float)(2)), ((float)(80)));
      ...
      this.workArea.Size = new System.Drawing.Size(1920, 1000);
      ...
      this.header1.Bounds = new NxtControl.Drawing.RectF(((float)(0)), ((float)(0)), ((float)(1920)), ((float)(80)));
    ...
    this.siblingsPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(0)), ((float)(1561)), ((float)(80)));
    ...
    this.childrenPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(39)), ((float)(1561)), ((float)(80)));
    ...
    this.childrenPanel.EndInit();
      ...
      this.login1.Bounds = new NxtControl.Drawing.RectF(((float)(1840)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.login1.Text = "";
      ...
      this.language1.Bounds = new NxtControl.Drawing.RectF(((float)(1880)), ((float)(0)), ((float)(40)), ((float)(40)));
      ...
      this.currentUser1.Bounds = new NxtControl.Drawing.RectF(((float)(1820)), ((float)(40)), ((float)(100)), ((float)(40)));
      ...
      this.runtimeConnection1.Bounds = new NxtControl.Drawing.RectF(((float)(1800)), ((float)(0)), ((float)(40)), ((float)(40)));
      ...
      this.newVersionDeployment1.Bounds = new NxtControl.Drawing.RectF(((float)(1760)), ((float)(0)), ((float)(40)), ((float)(40)));
